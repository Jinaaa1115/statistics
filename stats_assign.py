...
#This question involves calculating probability using the normal distribution. Although 
# the concept was taught theoretically, I am not yet confident in implementing it 
# using Python libraries such as SciPy, so I was unable to attempt it.
...
#This question requires calculating a confidence interval using statistical formulas 
# and Python libraries. While I understand the concept, the coding implementation using libraries like 
# SciPy was not covered in detail, so I could not attempt it.
...
#This question is based on hypothesis testing, which involves statistical 
# calculations and the use of specialized libraries. Since the practical coding part was not taught, 
# I was not confident in solving it programmatically.
...
#This question requires forming null and alternative hypotheses. Although 
# I understand the theoretical concept, I was unsure how to properly structure
#  and present it in a formal way, so I did not attempt it.
...
#This question involves calculating a confidence interval for a population 
# proportion using statistical methods. Since the implementation using Python libraries like
#  SciPy was not practiced in class, I was unable to solve it.
